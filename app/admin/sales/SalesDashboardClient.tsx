...
const BRAND_COLORS: Record<string, string> = {
  "Organic Valley": "bg-emerald-100 text-emerald-800 border-emerald-200",
  "Liquid I.V.": "bg-blue-100 text-blue-800 border-blue-200",
  "Earthbound Farm": "bg-lime-100 text-lime-800 border-lime-200",
};
