  ...
  const segments = [
    {
      ...
      topAdvertisers: ["Organic Valley", "Earthbound Farm"],
    ...
    },
    {
      ...
      topAdvertisers: ["Liquid I.V.", "Organic Valley"],
    ...
    },
    {
      ...
      description: "Regularly buys health foods, supplements, and low-processed items. Strong Liquid I.V. overlap.",
      ...
      topAdvertisers: ["Liquid I.V.", "Earthbound Farm"],
    ...
    },
    {
      ...
      description: "High-AOV shoppers who prioritize fresh, premium, and specialty items. Earthbound Farm's core audience.",
      ...
      topAdvertisers: ["Earthbound Farm", "Organic Valley"],
